    ...
    >
      <div className={`flex flex-col h-full ${style.bg} border ${style.border} rounded-xl overflow-hidden transition-all duration-300 backdrop-blur-md group-hover:border-white/20 ${style.glow}`}>
        ...
        <div className="p-2.5 space-y-1.5 flex-grow">
          <div>
            <h3 className="text-[10px] font-black font-orbitron text-white leading-tight uppercase group-hover:text-green-400 transition-colors line-clamp-2">
              {movie.title}
            </h3>
            <span className="text-[8px] font-share-tech text-gray-600 uppercase tracking-tighter">{movie.year}</span>
          </div>
          ...
          <div className="space-y-1">
            ...
            <p className="text-[8px] font-share-tech text-gray-500 line-clamp-2 leading-[1.1]">
              {movie.synopsis}
            </p>
          </div>
        </div>
